...
class Application(tk.Frame):
	...
	# This gives the user an opportunity to see the original image again
    def help(self, event):
    ...
    # This checks to see what the user entered and sends that direction to
    # _slide to do the actual sliding
    ...
    def create_board(self):
        ...
        for x in xrange(self.board_grid):
            for y in xrange(self.board_grid):
            	# x0 and y0 are in the upper left corner 
                x0 = x * self.piece_size
                y0 = y * self.piece_size
                # x1 and y1 are in the lower right corner
...
if __name__ == "__main__":
	...
	parser.add_option('-i', '--image', type=str, default='Mosaic1.png', 
		              help="path to image")
